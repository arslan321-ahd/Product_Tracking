<!-- Start - Sidebar Chat Box  -->
							...
							<div class="card-body contacts_body p-0 dz-scroll  " id="DZ_W_Contacts_Body">
								<ul class="contacts">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="assets/images/avatar/small/avatar10.webp"
													class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-header chat-list-header text-center">
								...
								<div class="dropdown">
									<a href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
										aria-expanded="false" class="dz-chat-dropdown dz-chatbox-btn">
		...
		<div class="deznav">
				...
				<ul class="metismenu" id="menu">
					...
					<li>
						...
						<ul aria-expanded="false">
							...
							<li><a href="index-2.html" data-i18n="Dashboard Dark">Dashboard Dark</a></li>
							<li><a href="construction/index.html" data-i18n="Construction"
									onclick="deleteAllCookie()">Construction</a></li>
						</ul>
					</li>
					<li>
					...
					<li>
						...
						<ul aria-expanded="false">
							...
							<li><a href="profile/projects-details.html" data-i18n="Projects Details">Projects
									Details</a></li>
					...
					<li>
						...
						<ul aria-expanded="false">
							...
							<li>
								...
								<ul aria-expanded="false">
									<li><a href="customer.html" data-i18n="Customer">Customer</a></li>
									<li><a href="customer-profile.html" data-i18n="Customer Profile">Customer
											Profile</a></li>
								</ul>
							</li>
							...
							<li>
								...
								<ul aria-expanded="false">
									...
									<li><a href="ecom-product-detail.html" data-i18n="Product Details">Product
											Details</a></li>
					...
					<li>
						...
						<ul aria-expanded="false">
							...
							<li><a href="aikit/fine-tune-models.html" data-i18n="Fine tune Models">Fine tune Models</a>
							</li>
							...
							<li><a href="aikit/import.html" data-i18n="Export/Import Settings">Export/Import
									Settings</a></li>
						</ul>
					</li>
					<li>
			...
			<div class="deznav-footer">
				<a href="https://coreui.w3itexperts.com/?theme=W3CRM" target="_blank"
					class="btn btn-docs btn-success w-100">
