									...
									<span class="input-group-text">
										<button class="bg-transparent border-0" aria-label="Header Search">
											<svg width="19" height="19" viewBox="0 0 19 19" fill="none"
												xmlns="http://www.w3.org/2000/svg">
												<circle cx="8.78605" cy="8.78605" r="8.23951"
													stroke="var(--bs-body-color)" stroke-linecap="round"
													stroke-linejoin="round" />
												<path d="M14.5168 14.9447L17.7471 18.1667" stroke="var(--bs-body-color)"
							...
							<li class="nav-item">
								<select class="selectpicker form-select i18n-select" id="langSwitcher">
									<option value="en_GB" title="English"
										data-content="<img src='assets/images/flags/gb-eng.svg' alt=''> English">English
									</option>
									<option value="pt_BR" title="Portuguese"
										data-content="<img src='assets/images/flags/pt.svg' alt=''> Português">Português
									</option>
								...
								<a class="nav-link btn-chatbox" href="javascript:void(0);" aria-label="Sidabar Chatbox">
									<svg width="20" height="22" viewBox="0 0 22 20" fill="none"
										...
										<path
											...
											stroke="var(--bs-body-color)" stroke-width="1.5" stroke-linecap="round"
											stroke-linejoin="round" />
								...
								<ul class="dropdown-menu dropdown-menu-end">
									<li>
										<div class="py-2 d-flex px-3">
											<img src="assets/images/tab/1.jpg" class="avatar avatar-sm rounded-circle"
												alt="">
											<div class="ms-2">
