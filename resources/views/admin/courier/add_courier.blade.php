                        ...
                        <form method="POST" action="{{ route('companies.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label class="form-label">Tracking Result</label>
                                    <textarea name="company_description" class="form-control @error('company_description') is-invalid @enderror" rows="4">{{ old('company_description') }}</textarea>
